...
local eq `"`eq'`:di %6.2f abs(_b[population])' pop"'
// add the error term
local eq `"`eq' + {&epsilon}"'
...
local eq `"`eq'`:di %6.2f abs(_b[lnpop])' lnpop"'
// add the error term
local eq `"`eq' + {&epsilon}"'
...
local eq `"`eq'`:di %6.2f abs(_b[size])' siz"'
// add the error term
local eq `"`eq' + {&epsilon}"'
...
// we already chose the plus or minus sign
// so we need to strip a minus sign when it is there
local eq `"`eq'`:di %6.2f abs(_b[lnsiz])' lnsiz"'
// add the error term
local eq `"`eq' + {&epsilon}"'
